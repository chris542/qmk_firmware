...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SymbolLayer] = CK_LAYOUT(
    ...
    XXXXXXX   , KC_CIRC , KC_PLUS , KC_LPRN , KC_RPRN , XXXXXXX , XXXXXXX ,
  ...
  [ArrowsLayer] = CK_LAYOUT(
    _______ , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,
    XXXXXXX , XXXXXXX , KC_P7   , KC_P8   , KC_P9   , XXXXXXX , XXXXXXX ,
    KC_LCTL , XXXXXXX , KC_P4   , KC_P5   , KC_P6   , KC_P0   , XXXXXXX ,
    KC_LSFT , XXXXXXX , KC_P1   , KC_P2   , KC_P3   , XXXXXXX ,
